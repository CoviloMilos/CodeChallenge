...
namespace TaskManagementAPI.Controllers
{
    ...
    public class TaskController : ControllerBase
    {
        ...
        public TaskController(ITaskRepository taskRepo, IMapper mapper, ILoggerManager logger, IRabbitManager manager)
        {
            _taskRepo = taskRepo;
            _mapper = mapper;
            _logger = logger;
        ...
        public async Task<IActionResult> GetTasks([FromQuery(Name = "prod")] string prod) 
        {
            ...
            if (tasks.Any())
            {
                return Ok(ResponseFormater("Tasks returned from database.", tasks, "success"));
            }
        ...
        public async Task<IActionResult> CreateTask([FromBody] DtoCreateTask dtoCreateTask) 
        {
            ...
            var task = _mapper.Map<TaskModel>(dtoCreateTask);
            ...
            throw new CustomException("task_create_failed", $"Task create failed on save");  
        }
        ...
        public async Task<IActionResult> UpdateTask(int taskId, [FromBody] DtoUpdateTask dtoUpdateTask)
        {
            ...
            throw new CustomException("task_update_failed", $"Updating task {taskId} failed on save");  
        }
        ...
        public async Task<IActionResult> UpdateCase([FromQuery] string taskGuid, int caseNum, [FromBody] DtoUpdateCase dtoUpdateCase)
        {
            ...
            throw new CustomException("case_update_failed", $"Updating case {caseNum} failed on save"); 
        }
